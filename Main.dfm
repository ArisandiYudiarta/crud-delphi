object FrmMain: TFrmMain
  ...
  object AdvOfficePager1: TAdvOfficePager
    ...
    object AdvOfficePager11: TAdvOfficePage
      ...
      object ButtonCustomer: TAdvSmoothButton
        Left = 25
        Top = 24
        Width = 169
        Height = 49
        ...
        Caption = 'Data Master Customer'
        TabOrder = 0
        Version = '2.0.1.0'
        OnClick = ButtonCustomerClick
      end
      object ButtonSupplier: TAdvSmoothButton
        Left = 216
        Top = 24
        Width = 177
        Height = 49
        ...
        Status.Appearance.Font.Name = 'Tahoma'
        Status.Appearance.Font.Style = []
        Caption = 'Data Master Supplier'
        TabOrder = 1
        Version = '2.0.1.0'
        OnClick = ButtonSupplierClick
      end
    end
    object AdvOfficePager12: TAdvOfficePage
      ...
      TabAppearance.BackGround.ColorTo = clNone
      TabAppearance.BackGround.Direction = gdHorizontal
      object btnRegistrasiTransaksi: TAdvSmoothButton
        Left = 25
        Top = 24
        Width = 177
        Height = 49
        ...
        Status.Appearance.Font.Name = 'Tahoma'
        Status.Appearance.Font.Style = []
        Caption = 'Data Registrasi Pembelian'
        TabOrder = 0
        Version = '2.0.1.0'
        OnClick = btnRegistrasiTransaksiClick
      end
    end
